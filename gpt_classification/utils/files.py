...
def configure():
    global __promt, __csv_file_name, __delimiter, __text_column
    with open('C:/Users/Home/PycharmProjects/Gpt/gpt_classification/configuration.txt', 'r', encoding='utf-8') as conf_file:
...
def read_csv_file():
    with open(f'C:/Users/Home/PycharmProjects/Gpt/gpt_classification/{__csv_file_name}', 'r', encoding='utf-8-sig') as csv_file:
